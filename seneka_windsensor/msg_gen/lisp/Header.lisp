...
(cl:defmethod cl:initialize-instance :after ((m <Header>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Header)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name seneka_windsensor-msg:<Header> is deprecated: use seneka_windsensor-msg:Header instead.")))
...
(cl:defmethod speed-val ((m <Header>))
...
(cl:defmethod direction-val ((m <Header>))
